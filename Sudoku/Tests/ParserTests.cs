...
namespace Tests
{
    ...
    {
        [Test]
        public void TestNineByNineParserFactory()
        {
            ISudokuParserFactory factory = new NineByNineParserFactory();
        ...
        [Test]
        public void TestJigsawParserFactory()
        {
            ISudokuParserFactory factory = new JigsawParserFactory();
        ...
        [Test]
        public void TestFourByFourParserFactory()
        {
            ISudokuParserFactory factory = new FourByFourParserFactory();
